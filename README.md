...
Каждая ветка представляет собой отдельную структуру базы данных и связанные с ней задачи.
...
5.  **Выполнить SQL запросы:**
    Решения по задачам в виде SQL запросов находятся в файле `solution.sql` в текущей ветке.  Вы можете выполнить их, используя свой клиент базы данных.
